...
if (num1 <= 1) {
    console.log ("1-ое число равно или меньше 1");
}   else {
    console.log ("1-ое число больше 1");
}
if (num2 >= 3) {
    console.log ("2-ое число больше или равно 3");
}   else {
    console.log ("2-ое число меньше 3");
}
...
if (day >= 1 && day <= 10) {
    alert(`Число ${day} 1-ая декада месяца`);
}
else if (day >= 11 && day <= 20) {
    alert(`Число ${day} 2-ая декада месяца`);
}
else if (day >= 12 && day <= 31) {
    alert(`Число ${day} 3-я декада месяца`);
}
else {
    alert(`Число ${day} меньше 1 или больше 31`);
}
